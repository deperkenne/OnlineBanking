...
function validateTransaction(transaction) {
  if (!transaction.accountIDB) return "account is required.";
  if (!transaction.montant) return "montant is required.";
  return "";
}

function validateAccount(account) {
  if (!account.name) return "id is required.";
  if (!account.id) return "id is required.";
  return "";
}
